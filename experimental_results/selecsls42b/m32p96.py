...
latency_fp = "layer_latency_m32p96.csv"
res1_fp = "res1_m32p96.csv"
res2_fp = "res2_m32p96.csv"
res_txt_fp = "res_m32p96.txt"
...
def main():
    ...
    effs = {}
    for k, v in layer_latency.items():
        effs.update({k: gop_s[k]/(32*96*0.398*2)})
